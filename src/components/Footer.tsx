    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-center md:text-left">
          ...
          {/* Links: Azul sutil, clean */}
          <nav className="flex space-x-6" role="navigation" aria-label="Links do rodapé">
            <Link href="/about" aria-label="Sobre o projeto">
              <Button 
                variant="link" 
                className="text-sm text-blue-600 hover:text-blue-700 p-0 h-auto font-medium transition-colors"
              >
                Sobre
              </Button>
            </Link>
